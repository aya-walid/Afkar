                    ...
                    <form action="{{route('step3')}}" id="form2" class="form-base" >
                        ...
                        <fieldset class="submit">
                            <div >
                                ...
                                <button type="submit"  class="action-button btnStep1" id="step2Val1" style="padding-right: 1rem!important;">Submit your idea<i class="fas fa-caret-right" style="font-size: -17px;margin-left: 21px;font-size: 25px; "></i> </button>

                                <a style="color: white;" id="step3Val2" class="action-button btnStep1" href="{{route('back','1')}}"><i class="fas fa-caret-left" style="margin-right: 21px;font-size: 25px; "></i>back</a>
                            </div>
                            <div>
                                <p>Step 2 of 4</p>
