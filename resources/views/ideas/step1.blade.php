                    ...
                    <form id="form" class="form-base" action="{{route('step2')}}">
                        ...
                        <fieldset class="pair">
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" value="{{Session::get('email')}}" tabindex="9">
                                @error('phone')
                                <span style="color: red; font-size: 16px;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <fieldset class="submit">
                            <div>
                                ...
                                <button type="submit"  class="action-button btnStep1" id="step1" style="padding-right: 1rem!important;">next<i class="fas fa-caret-right" style="
                      font-size: -17px;
                      margin-left: 21px;
                      font-size: 25px;
                  "></i> </button>
