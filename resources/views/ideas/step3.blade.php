        ...
        <div class="content-wrapper">
            ...
            <form action="{{route('step4')}}" id="form3" class="form-base">
                ...
                <div class="submit">
                    ...
                    <a style="color: white;" id="step3Val2" class="action-button btnStep1" href="{{route('back','2')}}"><i class="fas fa-caret-left" style="margin-right: 21px;font-size: 25px; "></i>back</a>
                    </div>
                    <div>Step 3 of 4</div>
                </div>
            </form>
