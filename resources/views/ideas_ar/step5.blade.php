...
<main class="page">
    ...
    <section class="lp-form pages">
        <div class="pages-wrap content-wrapper">
            <h1>نشكركم على الارسال والتواصل</h1>
            <p style="
        text-align: right;
    ">
                تم إرسال فكرتك بشكل آمن إلى دافيسون وعلم تتمثل الخطوة الأولى في مراجعة وتحديد ما إذا كانت الفكرة ضمن نطاق خدماتنا أم لا.        </p>
            <p style="
        text-align: right;
    ">
                سيحاول مدير المشروع الاتصال بك في غضون 3 إلى 5 أيام عمل لمناقشة فكرتك دون أي تكلفة. ننوه إلى أن الموظفين المحترفين في دافيسون وعلم يعملون على مراجعة فكرتك وسيتصلون بك في أقرب وقت ممكن.
            <p style="margin-bottom:20rem;text-align:right" >
                <br/>
                <strong>فريق دافيسون وعلم</strong>
                <br/>
