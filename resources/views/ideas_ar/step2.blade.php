        ...
        <div class="content-wrapper">
          ...
          ">
                            ...
                            <div>
                                ...
                                <button type="submit"  class="action-button btnStep1"  id="step2Val1" style="padding-right: 1rem!important;">ارسال الفكرة<i class="fas fa-caret-left" style="font-size: -17px;margin-right: 21px;font-size: 25px; "></i> </button>
                                <a style="color: white;" id="step3Val2" class="action-button btnStep1" href="{{route('back','1')}}"><i class="fas fa-caret-right" style="margin-left: 21px;font-size: 25px; "></i>السابق</a>
